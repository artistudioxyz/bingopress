...
//        $this->loadModulesHooks();
    ...
    public function loadModels() {
        $models = $this->Helper->getDirFiles( $this->path['framework_path'] . 'src/Model' );
    ...
    private function loadFeatures() {
        $features = $this->Helper->getDirFiles( $this->path['framework_path'] . 'src/Feature' );
        $allow    = array( '.', '..', '.DS_Store', 'index.php' );
    ...
    private function loadHooks( $dir ) {
        $controllers = $this->Helper->getDirFiles( $this->path['framework_path'] . 'src/' . $dir );
        $allow       = array( '.', '..', '.DS_Store', 'index.php' );
    ...
    public function generatePath( $path ) {
        ...
        $path              = array(
            ...
            'admin_url'   => admin_url(),
            'framework_path' => get_template_directory( $path ).DIRECTORY_SEPARATOR,
            'framework_url'  => get_template_directory_uri( $path ).DIRECTORY_SEPARATOR,
